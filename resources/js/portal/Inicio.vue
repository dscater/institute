<template>
    <div class="contenedor_inicio">
                ...
                <div class="row">
                        ...
                        <div class="single-feature">
                            ...
                            <div class="desc-wrap">
                                <p>
                                    ...
                                    learning about the celestial bodies begins
                    ...
                    <div class="col-lg-4">
                        <div class="single-feature">
                            ...
                            <div class="desc-wrap">
                                <p>
                                    If you are a serious astronomy fanatic like
                                    a lot of us are, you can probably remember
                                    that one event.
                                </p>
                                <a href="#">Join Now</a>
                            </div>
        ...
        <section class="search-course-area relative">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div
                        class="col-lg-4 col-md-6 search-course-right section-gap"
                    >
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="menu-content pb-70 col-lg-8">
                        <div class="title text-center">
                            <h1 class="mb-10">
                                Upcoming Events of our Institute
                            </h1>
                            <p>
                                If you are a serious astronomy fanatic like a
                                lot of us
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="active-upcoming-event-carusel">
                        <div class="single-carusel row align-items-center">
                            <div class="col-12 col-md-6 thumb">
                                <img
                                    class="img-fluid"
                                    :src="url_principal + '/images/e1.jpg'"
                                    alt=""
                                />
                            </div>
                            <div class="detials col-12 col-md-6">
                                ...
                                >
                                <p>
                                    For most of us, the idea of astronomy is
                                    something we directly connect to
                                    “stargazing”, telescopes and seeing
                        ...
                        <div class="single-carusel row align-items-center">
                            <div class="col-12 col-md-6 thumb">
                                <img
                                    class="img-fluid"
                                    :src="url_principal + '/images/e2.jpg'"
                                    alt=""
                                />
                            </div>
                            <div class="detials col-12 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="active-review-carusel">
                        ...
                        <div class="single-review item">
                            <img
                                :src="url_principal + '/images/r1.png'"
                                alt=""
                            />
                            <div class="title justify-content-start d-flex">
                                <a href="#"><h4>Fannie Rowe</h4></a>
        ...
        <!-- Start cta-one Area -->
        <section
            class="cta-one-area relative section-gap"
            :style="'background: url(' + url_principal + '/images/cta-bg.jpg);'"
        >
            <div class="container">
                <div class="overlay overlay-bg"></div>
                <div class="row justify-content-center">
                    <div class="wrap">
                        ...
                        <p>
                            ...
                            your own viewing station whether that is on the
                            deck.
                        </p>
                        <a class="primary-btn wh" href="#"
                            >Apply for the post</a
                        >
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 single-blog">
                        <div class="thumb">
                            <img
                                class="img-fluid"
                                :src="url_principal + '/images/b1.jpg'"
                                alt=""
                            />
                        </div>
                        <p class="meta">
                        ...
                        <p>
                            Computers have become ubiquitous in almost every
                            facet of our lives. At work, desk jockeys spend
                    ...
                    <div class="col-lg-3 col-md-6 single-blog">
                        <div class="thumb">
                            <img
                                class="img-fluid"
                                :src="url_principal + '/images/b2.jpg'"
                                alt=""
                            />
                        </div>
                        <p class="meta">
                        ...
                        <p>
                            Ah, the technical interview. Nothing like it. Not
                            only does it cause anxiety, but it causes anxiety
                    ...
                    <div class="col-lg-3 col-md-6 single-blog">
                        <div class="thumb">
                            <img
                                class="img-fluid"
                                :src="url_principal + '/images/b3.jpg'"
                                alt=""
                            />
                        </div>
                        <p class="meta">
                        ...
                        <p>
                            Plantronics with its GN Netcom wireless headset
                            creates the next generation of wireless headset and
                    ...
                    <div class="col-lg-3 col-md-6 single-blog">
                        <div class="thumb">
                            <img
                                class="img-fluid"
                                :src="url_principal + '/images/b4.jpg'"
                                alt=""
                            />
                        </div>
                        <p class="meta">
                        ...
                        <p>
                            ...
                            online that they wouldn’t want their parents to know
